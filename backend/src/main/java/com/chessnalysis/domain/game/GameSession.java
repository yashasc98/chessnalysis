...
@Table(name = "game_sessions", indexes = {
	@Index(name = "idx_game_white_player", columnList = "white_player_id"),
	@Index(name = "idx_game_black_player", columnList = "black_player_id"),
	@Index(name = "idx_game_state", columnList = "game_state"),
